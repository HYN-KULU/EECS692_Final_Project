...
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch benchmark_mw.py --env_name $task --n_exps 5 --ckpt_dir "../ckpts/metaworld_DA" --milestone 24 --result_root "../results/results_AVDC_mw_DA"
done
